<template>
  <div>
    ...
    <p>Last updated: April 07, 2021</p>
    <p>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Eatsy, Singapore.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Eatsy, accessible from
          <a
            href="www.eatsy.com"
    ...
    <ul>
      <li>By email: hello@eatsy.com</li>
    </ul>
  </div>
</template>
